			...
			<div class="page-content d-flex align-items-center justify-content-center">
                ...
                <div class="col-md-4 pr-md-0">
                  <div class="auth-left-wrapper">
                  	<img style="width: 100%; height: 780px;" src="../assets/backend/images/asd.png">
                  </div>
                </div>
                <div class="col-md-8 pl-md-0">
                  <div class="auth-form-wrapper px-4 py-5">
                    ...
                    <form class="forms-sample" method="post" action="index.php?controller=login&action=registerPost">
                      ...
                      <div class="form-group">
                        <label for="exampleInputPassword1">Thói quen</label>
                        <input type="password" name="thoi_quen" required class="form-control" id="exampleInputPassword1" autocomplete="current-password" placeholder="Thói quen">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword1">Sở thích</label>
                        <input type="password" name="so_thich" required class="form-control" id="exampleInputPassword1" autocomplete="current-password" placeholder="Sở thích">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword1">Ngày sinh</label>
                        <input type="date" name="sinh_nhat" required class="form-control" id="exampleInputPassword1" autocomplete="current-password" placeholder="Ngày sinh">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputPassword1">Số điện thoại</label>
                        <input type="text" name="phone" required class="form-control" id="exampleInputPassword1" autocomplete="current-password" placeholder="Số điện thoại">
                      </div>
					  <div style="color: red">
					...
					<a href="index.php?controller=login" class="d-block mt-3 text-muted">Bạn đã là thành viên? <span style="color: blue;">Đăng nhập</span></a>
                  </div>
                </div>
              </div>
						</div>
